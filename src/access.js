export const PERMISSIONS = {
  ...
  stockAuditView: 'stock.audit_view',
  ...
  reportViewSalesToday: 'report.view_sales_today',
  reportViewSalesYesterday: 'report.view_sales_yesterday',
  reportViewSalesWeek: 'report.view_sales_week',
  reportViewSalesMonth: 'report.view_sales_month',
  reportViewSalesYear: 'report.view_sales_year',
...
const COMPANY_PAGE_PERMISSION_RULES = {
  ...
  reports: [
    PERMISSIONS.reportViewInventory,
